...
import com.mymusic.orvai.travel_with.WebRTC.util.AppRTCUtils;
 ...
 * It returns just two values "NEAR" or "FAR". Thresholding is done on the LUX value i.e. the LUX value of the light sensor is compared with a threshold.
